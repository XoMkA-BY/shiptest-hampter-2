...
/datum/modpack/quirks
	name = "Новые квирки"
	desc = "Этот мод добавляет новые перки в меню покупок. \
			Повышенное выживаемость. \
			Дварфизм. \
			Быстрое снятие оков (Quick removal of handcuffs)."
	author = "MrCat15352, RedSybrex"
...
// Инициализация ДО
/datum/modpack/quirks/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/quirks/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/quirks/post_initialize()
	. = ..()
